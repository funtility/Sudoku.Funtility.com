...
function isValidateCellValue(event) {
    // console.log('validateCellValue')
    let num = parseInt(event.target.value)
    if (isNaN(num) || num > matrix**2 || num < 1) {
...
function loadPuzzle()
{
    cells.forEach((c) => {
        ...
        {
            sudokuPuzzle.setValue(parseInt(c.dataset.row),parseInt(c.dataset.col),parseInt(c.value))
        }
    })
}
...
//     log = new Log()
//     log.entry('Given Cell Phase')
//     setGivenCells()
//     log.entry('Forced Cell Phase')
//     // setForcedCells();
//     log.end()
// }
...
//     cells.forEach((c) => {
//         if (!isNaN(parseInt(c.value))) {
//             c.setAttribute('data-given',c.value)
//             c.setAttribute('disabled','true')
//         }
//     })
// }

// function setForcedCells(type){
...
//         } else {
//             setMarkup(openCells)
//             processing = !setExclusiveForcedCells() && !setSingletonForcedCells()
//         }
//     }
// }
...
//     let openCells = []
//     cells.forEach((c) => {
//         if (!c.dataset.given && !c.dataset.forced && !c.dataset.guess){
//             openCells.push(c)
//         }
//     })
//     return openCells
...
// function setMarkup(openCells){
//     // console.log('setMarkup')
//     openCells.forEach((openCell) => {
//         let markup = getMatrixSet()
//         areas.forEach((area) => {
//             let areaCells = document.querySelectorAll(`[data-${area}='${openCell.dataset[area]}']`)
//             areaCells.forEach((areaCell) => {
//                 removeFromArray(markup,Number(areaCell.dataset.given))
//                 removeFromArray(markup,Number(areaCell.dataset.forced))
//                 removeFromArray(markup,Number(areaCell.dataset.guess))
//             })
//         })
//         openCell.setAttribute('data-markup',JSON.stringify(markup))
//     })
// }
...
//     if (array.includes(i)){
//         let index = array.findIndex((e) => e === i)
//         array.splice(index,1)
//     }
// }

// function setExclusiveForcedCells(){
//     let hadForcedCells = false;
//     let openCells = document.querySelectorAll('[data-markup]')
//     openCells.forEach((openCell) => {
//         let m = JSON.parse(openCell.dataset.markup)
//         if(m.length === 1){
//             openCell.setAttribute('data-forced',m[0])
//             openCell.removeAttribute('data-markup')
//             hadForcedCells = true
//         }
//     })
//     return hadForcedCells
// }

// function setSingletonForcedCells(){
//     let hadForcedCells = false;
//     // let openCells = document.querySelectorAll('[data-markup]')
//     let matrixSet = getMatrixSet()
//     areas.forEach((area) => {
//         matrixSet.forEach((n) => {
//             let areaCells = document.querySelectorAll(`[data-${area}='${n}']`)
//             let singletonSet = getSingletonSet()
//             // console.log(singletonSet)
//             areaCells.forEach((c) => {
//                 if (c.dataset.markup){
//                     JSON.parse(c.dataset.markup).forEach((n) => {
//                         singletonSet[n-1].ids.push(c.id)
//                     })
//                 }
//             })
//         })
...
// function getAreaSingletons(){

// }

// function getSingletonSet(){
//     let matrixSet = getMatrixSet()
//     let singletonSet = []
//     matrixSet.forEach((n) => {
//         singletonSet.push({
